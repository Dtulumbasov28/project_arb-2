...
export function menuInit() {
	// Прослушивание клика на кнопку с классом ".icon-menu"
	...
	// Добавляем прослушивание для всех кнопок с классом ".menu__close"
	document.querySelectorAll(".menu__close").forEach(button => {
		button.addEventListener("click", function () {
			// Удаляем классы "menu-open" и "lock" с элемента <html>, если они там есть
			if (document.documentElement.classList.contains("menu-open")) {
				document.documentElement.classList.remove("menu-open");
				document.documentElement.classList.remove("lock"); // Удаляем также класс "lock"
			}
		});
	});
}
